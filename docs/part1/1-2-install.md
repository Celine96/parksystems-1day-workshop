...
### [실습] 시각화 도구 Nimbalyst 다운로드 (1교시 준비)

1교시부터 클로드 코드가 파일을 바꾸는 모습을 **눈으로 보면서** 진행할 거예요. 그래서 **Nimbalyst**라는 무료 도구를 미리 받아둘게요.
...
**Step 3.** 한 번 열어서 정상 실행되는지 확인. (1교시에 다시 열어서 본격 사용해요.)
