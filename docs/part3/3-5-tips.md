...
> - **용어 규칙** — 예: "RFM = Revision File Manager", "LOM = List of Manuals"
...
```
매뉴얼 팀장으로서 매뉴얼 작업 초기 기획안과 비교해 목표·필수 섹션이
...
> 부록 끝. 🎉
>
> **본 수업 + 부록 모두 마쳤습니다.** 워크숍에서 만든 두 에이전트(PM 에이전트 JARVIS · 에디터 에이전트 Editor)는 여러분 프로젝트 폴더의 `.claude/agents/`에 저장되어 있어요. 본업으로 돌아가셔서 자유롭게 부려보세요.
>
