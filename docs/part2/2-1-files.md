...
> 💡 **포인트**: 클로드는 우리의 요청대로만 따르는 게 아니라 (1) **계획을 먼저** 보여주고 (2) **판단한 근거까지 메모**로 남겨요. 결과가 의도와 다르면 바로 잡을 수 있고, ".stp 확장자라 raw로 분류" 같은 추론 과정이 투명하게 드러나요.
>
> 💬 학습자 화면의 실제 출력은 사람마다 살짝 달라질 수 있어요. 큰 흐름(계획 → 실행 → 보고 + 메모)만 같으면 정상이에요.
...
- [ ] Nimbalyst 창을 터미널 옆에 두고 파일 변화를 시각적으로 확인함
