...
<p style="font-size: 1.2em; font-weight: 700; color: var(--vp-c-brand-1); margin: 24px 0 8px;">📌 응용 2. 주간 보고 형식으로 <span style="color: var(--vp-c-text-2); font-weight: 400; font-size: 0.85em;">— 회사 양식 그대로 출력</span></p>
...
<p style="font-size: 1.2em; font-weight: 700; color: var(--vp-c-brand-1); margin: 24px 0 8px;">📌 응용 3. 빈번 사용 폴더 찾기 <span style="color: var(--vp-c-text-2); font-weight: 400; font-size: 0.85em;">— 가장 바쁜 팀이 어디인지</span></p>
...
> 📚 더 깊이 알고 싶으면 부록 11 "에이전트 & 하네스 엔지니어링 딥다이브"를 봐주세요. 본 수업에서는 이 정도만!
