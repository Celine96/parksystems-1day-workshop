...
JARVIS는 내 로컬 노트북에서 폴더를 들여다보고 진행 상황을 파악해서, 내가 지시한 규칙대로 단계를 자동 판정하고, 사람 말로 묻기만 하면 정리된 보고서로 답변해줘요.
...
## [응용 - 본 수업 끝나고] 회사 노트북 폴더에 PM 에이전트를 사용하려면?
